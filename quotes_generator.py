...
def preload_quotes():
    ...
    for x in range(10):
        ...
        print(quote)
        quotes.append(quote)
    print("***Finished loadng More Quotes***")
preload_quotes()
...
def get_random_quote():
    ...
    if quotes[quote_number] == quotes[-3]:
        ...
        thread.start()
#UI
quote_label = tk.Label(window,text='Click on the button to generate a random Number',height=6,pady=10,wraplength=800,font=('Helvetica',14))
